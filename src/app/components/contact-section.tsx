...
// Destination options (you can expand this list)
...
type FormDataState = {
  ...
  adults: number; // Change from string to number
  children: number; // Change from string to number
...
export default function ContactSection() {
  const [formData, setFormData] = useState<FormDataState>({
    ...
    adults: 1, // Change from "1" to 1
    children: 0, // Change from "0" to 0
    tripPlanningStatus: "",
    timeToBook: "",
    additionalDetails: "",
  });
